...
for i in range(500000):
    ...
    f.write("insert into myBookUser values('"+"US"+str(userid)+"','"+firstname+"','"+lastname+"','"+username+"','"+phonenumber+"','"+email+"','"+country+"') \n")
    f.write("insert into uProfile values('"+"US"+str(userid)+"','"+"PF"+str(profileNo)+"','"+profilepic+"','"+biography+"')\n")
    print(str(i)+"\n")
